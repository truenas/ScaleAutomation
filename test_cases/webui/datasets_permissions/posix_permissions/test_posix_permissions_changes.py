...
@pytest.mark.parametrize('posix_acl_permissions', get_data_list('dataset_permission/posix_acl_custom'), scope='class')
class Test_POSIX_Permissions_Changes:
    ...
    def test_change_owner_and_group(self, posix_acl_custom) -> None:
        """
