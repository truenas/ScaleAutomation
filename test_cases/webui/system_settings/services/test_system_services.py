...
class Test_System_Services:
    ...
    def test_verify_system_services_start(self, services):
        ...
        assert API_POST.is_service_running(SERV.return_backend_service_name(services['service_name'], False)) is runnable_bool
        SERV.stop_service_by_api(services['service_name'])
    ...
    def test_verify_system_services_stop(self, services):
        ...
        assert SERV.is_service_running_toggle_enabled(services['service_name']) is False
        assert API_POST.is_service_running(SERV.return_backend_service_name(services['service_name'], False)) is False
