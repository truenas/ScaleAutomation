...
@allure.tag('Share Admin', 'Directory Services', 'Permissions', 'Users')
@allure.epic('Permissions')
@allure.feature('Share Admin')
class Test_Share_Admin_Directory_Services:
    ...
    @allure.story('Share Admin Is Not Able to Configure Active Directory')
    def test_share_admin_is_not_able_to_configure_active_directory(self, navigate_to_directory_services):
        """
        This test verifies the share admin is not able to configure active directory.
    ...
    @allure.story('Share Admin Is Not Able to Configure LDAP')
    def test_share_admin_is_not_able_to_configure_ldap(self, navigate_to_directory_services):
        """
        This test verifies the share admin is not able to configure LDAP.
        1. Navigate to Directory services page
    ...
    @allure.story('Share Admin Is Not Able to Add Kerberos and Idmap in Advanced Settings')
    def test_share_admin_is_not_to_add_kerberos_and_idmap_in_advanced_settings(self, navigate_to_directory_services):
        """
        This test verifies the share admin is not able to add kerberos and idmap in advanced settings.
        1. Navigate to Directory services page
    ...
    @allure.story('Share Admin Is Able to View Pre-Configured Active Directory')
    @pytest.mark.parametrize('ad_data', get_data_list('ad_credentials'), scope='class')
    def test_share_admin_is_able_to_view_pre_configured_active_directory(self, ad_data, setup_ad, tear_down_ad):
        """
        This test verifies the share admin is able to view pre-configured active directory.
        1. Configure active directory as admin
        2. Navigate to Directory services page as share admin
    ...
    @allure.story('Share Admin Is Able to View Pre-Configured LDAP')
    @pytest.mark.parametrize('ldap_data', get_data_list('ldap_credentials'), scope='class')
    def test_share_admin_is_able_to_view_pre_configured_ldap(self, ldap_data, setup_ldap, tear_down_ldap):
        """
        This test verifies the share admin is able to view pre-configured LDAP.
    ...
    @allure.story('Share Admin Is Able to View Directory Services Advanced Settings')
    @pytest.mark.parametrize('ad_data', get_data_list('ad_credentials'), scope='class')
    def test_share_admin_is_able_to_view_directory_services_advanced_settings(self, ad_data, setup_ad, tear_down_ad):
        """
        This test verifies the share admin is able to view Directory services advanced settings.
        1. Configure active directory as admin
        2. Navigate to Directory services page as share admin
    ...
    @allure.tag('Update', 'Active Directory')
    @allure.story('Share Admin Is Not Able to Modify Pre-Configured Active Directory')
    @pytest.mark.parametrize('ad_data', get_data_list('ad_credentials'), scope='class')
    def test_share_admin_is_not_able_to_modify_pre_configured_active_directory(self, ad_data, setup_ad, tear_down_ad):
        """
        This test verifies the share admin is not able to modify pre-configured active directory.
        1. Configure Active Directory as admin
        2. Navigate to Directory services page as share admin
    ...
    @allure.tag('Update', 'LDAP')
    @allure.story('Share Admin Is Not Able to Modify Pre-Configured LDAP')
    @pytest.mark.parametrize('ldap_data', get_data_list('ldap_credentials'), scope='class')
    def test_share_admin_is_not_able_to_modify_pre_configured_ldap(self, ldap_data, setup_ldap, tear_down_ldap):
        """
        This test verifies the share admin is not able to modify pre-configured LDAP.
        1. Configure LDAP as admin
        2. Navigate to Directory services page as share admin
    ...
    @allure.story('Share Admin Is Not Able to Modify Directory Services Advanced Settings')
    @pytest.mark.parametrize('ad_data', get_data_list('ad_credentials'), scope='class')
    def test_share_admin_is_not_able_to_modify_directory_services_advanced_settings(self, ad_data, setup_ad, tear_down_ad):
        """
        This test verifies the share admin is not able to modify any directory service advanced settings.
        1. Configure Active Directory as admin
        2. Navigate to Directory services page as share admin
        3. Click on Show advanced settings button
