...
@allure.tag('Share Admin', 'System Settings', 'Advanced Page', "Users", 'Permissions')
...
class Test_Share_Admin_System_Settings_Advanced:
    ...
    @allure.story("Share Admin Can See the System Settings Advanced Page")
    def test_share_admin_can_see_the_system_settings_advanced(self):
        """
        Summary: This test verifies the share admin is able to access and see all details in the System Settings > Advanced view.

        Test Steps:
        1. Verify the share admin is able to see Advanced view page (title, Save Debug button)
        2. Verify the share admin is able to see various Card details (Console, Syslog, Audit, Kernel)
        """
    ...
    @allure.story("Share Admin Is Not Able to Modify Any Advanced Settings")
    def test_share_admin_not_able_to_modify_any_advanced_settings(self):
        """
        Summary: This test verifies the share user is not able to modify any advanced settings.
