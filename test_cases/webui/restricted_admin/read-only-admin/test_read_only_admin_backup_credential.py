...
class Test_Read_Only_Admin_Backup_Credential:
    ...
    def setup_backup_credential(self, cloud_cred, rep, add_ssh_connection):
        """
        Summary: This setup fixture create the Cloud Credentials for all test cases.
        """
    ...
    @pytest.fixture(autouse=True, scope='class')
    def teardown_backup_credential(self, cloud_cred):
        """
        Summary: This teardown fixture delete the Cloud Credentials for all test cases.
        """
        yield
