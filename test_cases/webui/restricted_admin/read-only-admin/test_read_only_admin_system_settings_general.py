...
@allure.tag('Read Only Admin', 'System Settings', 'General Page', "Users", 'Permissions')
@allure.epic('Permissions')
@allure.feature('Read Only Admin')
class Test_Read_Only_Admin_System_Settings_General:
    ...
    @allure.tag("Read")
    @allure.story("Read Only Admin Can See the System Settings General Page")
    def test_read_only_admin_can_see_the_system_settings_general(self):
        """
        Summary: This test verifies the read-only admin is able to access and see all details in the System Settings > General view.

        Test Steps:
        1. Verify the read-only admin is able to see General view page (title, Manage Config button)
        2. Verify the read-only admin is able to see Support Card details
        3. Verify the read-only admin is able to see GUI Card details
        4. Verify the read-only admin is able to see NTP LocalizationServers Card details
        5. Verify the read-only admin is able to see NTP Servers Card details
        6. Verify the read-only admin is able to see Email Card details
        """
    ...
    @allure.tag("Update")
    @allure.story("Read Only Admin Is Not Able to Update the Software Version")
    def test_read_only_admin_not_able_to_update_the_software_version(self):
        """
        Summary: This test verifies the read-only user is not able to update the software version on the system.
    ...
    @allure.tag("Create")
    @allure.story("Read Only Admin Is Not Able to Add License")
    def test_read_only_admin_not_able_to_add_license(self):
        """
        Summary: This test verifies the read-only user is not able to add a license.
    ...
    @allure.tag("Create")
    @allure.story("Read Only Admin Can File A Ticket")
    def test_read_only_admin_can_file_a_ticket(self):
        """
        Summary: This test verifies the read-only admin is able to file a ticket from the system settings > general view.
    ...
    @allure.tag("Update")
    @allure.story("Read Only Admin Is Not Able to Change GUI Settings")
    def test_read_only_admin_not_able_to_change_gui_settings(self):
        """
        Summary: This test verifies the read-only user is not able to change GUI settings.
    ...
    @allure.tag("Update")
    @allure.story("Read Only Admin Is Not Able to Change Localization Settings")
    def test_read_only_admin_not_able_to_change_localization_settings(self):
        """
        Summary: This test verifies the read-only user is not able to change Localization settings.
    ...
    @allure.tag("Create")
    @allure.story("Read Only Admin Is Not Able to Add an NTP server")
    def test_read_only_admin_not_able_to_add_an_ntp_server(self):
        """
        Summary: This test verifies the read-only user is not able to add an NTP server.
    ...
    @allure.tag("Update")
    @allure.story("Read Only Admin Is Not Able to Delete an NTP server")
    def test_read_only_admin_not_able_to_delete_an_ntp_server(self):
        """
        Summary: This test verifies the read-only user is not able to delete an NTP server.
    ...
    @allure.tag("Update")
    @allure.story("Read Only Admin Is Not Able to Modify Email Options")
    def test_read_only_admin_not_able_to_modify_email_options(self):
        """
        Summary: This test verifies the read-only user is not able to modify email options.
