...
@allure.tag('Read Only Admin', 'Jobs', 'Tasks', 'Permissions')
@allure.epic('permissions')
@allure.feature('Read Only Admin')
class Test_Read_Only_Admin_Jobs_Task:
    ...
    @allure.story('Read Only Admin Can View the List of Jobs and Tasks that They Have Triggered')
    def test_read_only_admin_can_view_the_list_of_jobs_and_tasks_that_they_have_triggered(self):
        """
        This test verifies the read only admin is able to view the list of jobs and tasks that they have triggered.
