...
class Test_Edit_WG_Easy_Configuration:
    ...
    def verify_edit_values() -> None:
        ...
        Apps.edit_app('WG Easy')
        Apps.navigate_to_app_section('Network Configuration')
        assert COM.get_element_property('host', 'value') == '10.234.27.201'
        assert COM.get_element_property('password', 'value') == 'test1234'
        assert COM.get_element_property('keep-alive', 'value') == '50'
        assert COM.get_element_property('client-mtu', 'value') == '2840'
        assert COM.get_element_property('client-address-range', 'value') == '10.16.0.x'
        assert COM.get_element_property('client-dns-server', 'value') == '2.2.2.2'
