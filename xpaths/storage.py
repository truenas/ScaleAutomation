...
def label_disk_name_by_row(row: int) -> str:
    """
    This method returns the disk name xpath text of the given row.
...
def pool_cards_item_value(pool_name: str, item: str, value: str) -> str:
    """
    This method returns the xpath text of the given pool name, item and value.
...
def pool_name_header(pool_name: str) -> str:
    """
    This method returns the xpath text of the given pool name header.
    :param pool_name: the name of the pool
